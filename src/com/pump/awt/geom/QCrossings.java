/*
 * This is a derivative of sun.awt.geom.Crossings. Its original license reads:
 *
...
public abstract class QCrossings {
    ...
    public QCrossings(double xlo, double ylo, double xhi, double yhi) {
        this.xlo = xlo;
        this.ylo = ylo;
        this.xhi = xhi;
        this.yhi = yhi;
    ...
    public static QCrossings findCrossings(Vector<? extends QCurve> curves,
                                                       double xlo, double ylo,
                                                       double xhi, double yhi)
    {
        QCrossings cross = new QCrossings.EvenOdd(xlo, ylo, xhi, yhi);
        Enumeration<? extends QCurve> enum_ = curves.elements();
    ...
    public static QCrossings findCrossings(PathIterator pi,
                                                       double xlo, double ylo,
                                                       double xhi, double yhi)
    {
        QCrossings cross;
    ...
    private Vector<QCurve> tmp = new Vector<>();
    ...
    public boolean accumulateQuad(double x0, double y0, double[] coords) {
        ...
        Enumeration<QCurve> enum_ = tmp.elements();
        while (enum_.hasMoreElements()) {
            QCurve c = enum_.nextElement();
    ...
    public static final class EvenOdd extends QCrossings {
    ...
    public static final class NonZero extends QCrossings {
