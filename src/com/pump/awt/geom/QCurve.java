/*
 * This is a derivative of sun.awt.geom.Curve. Its original license reads:
 *
...
public abstract class QCurve {
    ...
    public static void insertLine(ExposedArrayWrapper<QCurve> curves,
                                  double x0, double y0,
                                  double x1, double y1)
    {
        if (y0 < y1) {
    ...
    public static void insertQuad(ExposedArrayWrapper<QCurve> curves,
                                  double x0, double y0,
                                  double[] coords)
    {
        double y1 = coords[3];
        if (y0 > y1) {
            QOrder2.insert(curves, coords,
                    coords[2], y1,
                    coords[0], coords[1],
                    x0, y0,
                    DECREASING);
    ...
    public static void insertCubic(ExposedArrayWrapper<QCurve> curves,
                                   double x0, double y0,
                                   double[] coords)
    {
        double y1 = coords[5];
        if (y0 > y1) {
            QOrder3.insert(curves, coords,
                    coords[4], y1,
                    coords[2], coords[3],
                    coords[0], coords[1],
                    x0, y0,
    ...
    public boolean findIntersect(QCurve that, double[] yrange, double ymin,
