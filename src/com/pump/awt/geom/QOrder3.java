/*
 * This is a derivative of sun.awt.geom.Order3. Its original license reads:
 *
...
final class QOrder3 extends QCurve {
    ...
    public static void insert(Vector<QCurve> curves, double[] tmp,
                              double x0, double y0,
    ...
    public static void addInstance(Vector<QCurve> curves,
                                   double x0, double y0,
                                   double cx0, double cy0,
                                   double cx1, double cy1,
                                   double x1, double y1,
    ...
    public QOrder3(double x0, double y0,
                  double cx0, double cy0,
                  double cx1, double cy1,
                  double x1, double y1,
                  int direction)
    ...
    public double TforY(double y) {
        ...
        if (ycoeff3 == 0.0) {
            ...
            return QOrder2.TforY(y, ycoeff0, ycoeff1, ycoeff2);
        }
    ...
    public QCurve getSubCurve(double ystart, double yend, int dir) {
        ...
        return new QOrder3(eqn[i+0], ystart,
                eqn[i+2], eqn[i+3],
                eqn[i+4], eqn[i+5],
                eqn[i+6], yend,
                dir);
